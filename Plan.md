...
Для снижения времменых рисков на автоматизацию и упрощения дальнейшего сопровождения и поддержки автотестов будт реализована трех-уровневая архитектура автотестов на основе Page Objects (реализует DTO через публичные статические переменные, на каждую страницу и крупный групповой объект свой Page Objects), унаследованных от базового класса (реализует типовые действия с элементами Page Objects).
