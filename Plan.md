...
* перезапуск приложения после авторизации и выхода
* проверка работы приложения при выключении устройства с запущенным приложением
* проверка работы приложения при сворачивании, переключении между экранами
* тестирование работы приложения с прерываниями на устройстве (звонки, сообщения, пушпул уведомления)
...
## Стратегия и последовательность автоматизации тестирования приложения
Для снижения времменых рисков на автоматизацию и упрощения дальнейшего сопровождения и поддержки автотестов будт реализована архитектура автотестов на основе Page Objects, унаследованных от базового класса (реализует типовые действия с элементами Page Objects).
Для стабильности автотестов будут использоваты задежки для компенсации загрузки страниц, анимации окон, вспывающих сообщений, экранной клавиатуры, быстродействия устройства.
Каждый тест проводится изолированно, начиная с запуска приложения и страницы авторизации.
